...
[Vimspector](https://github.com/puremourning/vimspector#supported-languages)是一个基于*DAP(debug adapter protocol)*的Vim多语言调试插件，理论上能够支持所有支持语言（只要有对应的 DAP），对C/C++、Python 等流行的语言已经进行了充分的测试。这个插件仍在实验阶段，有些重要功能还没有实现。这篇文章以调试 C/C++ 程序为例，介绍 vimspector 的配置与使用。
...
![predefined variables](https://gitee.com/kongjun18/image/raw/master/Screenshot_20201212_213955.png)
...
![vimspector-screenshot](https://gitee.com/kongjun18/image/raw/master/vimspector-screenshot.gif)
...
```
![](https://gitee.com/kongjun18/image/raw/master/1954702-20200505175802855-63918029.png)
开启 human mode：

```
let g:vimspector_enable_mappings = 'HUMAN'
```
![](https://gitee.com/kongjun18/image/raw/master/1954702-20200505175855111-809170906.png)
